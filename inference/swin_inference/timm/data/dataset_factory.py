...
from .dataset import IterableImageDataset, ImageDataset, COVID_Dataset
...
def create_dataset(
    ...
    if name.startswith('torch/'):
        ...
        ds = COVID_Dataset(csv_path = r'D:\NCKU\ACVLab\Competition\COVID19\pytorch-image-models-master\df_224_5_v2.csv',
                           data_split = split,
                           transform = None)
    elif name == 'covid_val':
        ds = COVID_Dataset(csv_path = r'D:\NCKU\ACVLab\Competition\COVID19\pytorch-image-models-master\df_224_v2.csv',
                           data_split = split,
                           transform = None)
    elif name == 'covid_test':
        ds = COVID_Dataset(csv_path = '/home/fate/covid19_CT2/test_224_embed.pkl',
                           data_split = split,
                           transform = None)
    else:
